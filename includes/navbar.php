  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        <a href="#" class="navbar-brand"><b>eVoting</b>System</a>
        ...
        <div class="col-xs-12">
          <h3>Votes Tally
            <span class="pull-right">
              <a href="election_result.pdf" class="btn btn-success btn-sm btn-flat"><span class="glyphicon glyphicon-print"></span> Print</a>
            </span>
          </h3>
        </div>
      </div>